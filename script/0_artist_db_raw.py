...
def get_nationality_from_deepseek(artist_name):
    ...
    Returns nationality in English.
    """
    ...
    try:
        # Prompt explicitly asks for English country name
...
def create_database():
    ...
    for i, name in enumerate(artists, start=1):
        ...
        # Get nationality with DeepSeek (returns English country name)
    ...
    print(f"📋 Table 'Artist' with genres and nationality (in English)")
